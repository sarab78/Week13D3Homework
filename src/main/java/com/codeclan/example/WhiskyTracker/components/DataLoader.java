...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Whisky> year = whiskyRepository.findWhiskeyByParticularYear(2018);

        List<Distillery> region = distilleryRepository.findDistilleryByParticularRegion("Lowland");
